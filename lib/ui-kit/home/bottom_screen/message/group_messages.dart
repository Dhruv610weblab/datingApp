...
class _GroupMessagesState extends State<GroupMessages> {
  List<Map<String, dynamic>> chatList = <Map<String, dynamic>>[
    {
      "group_name": "House keeping",
      "name": "Moley",
      "message": "hello",
      "time": "19 min",
      "image": 'assets/groups/house keeping.png',
      "unread": true,
      "isStory": false,
      "count": "2"
    },
    ...
    },
    {
      ...
      "message": "Javan",
      "time": "19 min",
      "image": 'assets/groups/movie.jpeg',
      "unread": true,
      "isStory": false,
      "count": "2"
    },
    {
      "group_name": "Valuteer events",
      "name": "Sam",
      "message": "Typing...",
      "time": "19 min",
      "image": 'assets/groups/events.jpeg',
      "unread": false,
      "isStory": false,
      "count": ""
    },
    ...
    },
    {
      ...
      "message": "Love 😍",
      "time": "23 min",
      "image": 'assets/groups/hiking.jpeg',
      "unread": true,
      "isStory": false,
      "count": "1"
    }
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ChatCard(
                                fem: fem,
                                ffem: ffem,
                                name: chatList[index]["group_name"],
                                message: chatList[index]["name"] +
                                    ": " +
